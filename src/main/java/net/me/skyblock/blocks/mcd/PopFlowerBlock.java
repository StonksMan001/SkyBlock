package net.me.skyblock.blocks.mcd;
...
public class PopFlowerBlock extends PlantBlock implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return BlockEntityAPI.createTickerHelper(type, SkyBlockRegistries.BlockEntityRegistries.MCD__POP_FLOWER_BLOCK_ENTITY, PopFlowerBlockEntity::serverTick);
    }
