...
public class TanglyStoneSlabBlock extends SlabBlock {
    private final Block convertsTo;
    @Nullable
    private Block driesTo;
    private final Item item;
    public TanglyStoneSlabBlock(Settings settings, Item item, Block convertsTo) {
        super(settings);
        this.item = item;
        this.convertsTo = convertsTo;
    }
    public TanglyStoneSlabBlock(Settings settings, Item item, Block convertsTo, @Nullable Block driesTo) {
        super(settings);
        this.item = item;
        this.convertsTo = convertsTo;
