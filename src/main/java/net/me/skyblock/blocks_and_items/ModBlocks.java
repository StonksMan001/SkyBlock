...
public class ModBlocks {
    ...
    public static final Block ABYSS_JUNGLE_STAIRS = registerBlock("abyss_jungle_stairs",
            new ModStairsBlock(ModBlocks.ABYSS_JUNGLE_PLANKS.getDefaultState(), FabricBlockSettings
    ...
    public static final Block BLARU_STAIRS = registerBlock("blaru_stairs",
            new ModStairsBlock(ModBlocks.BLARU_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block FROZEN_STAIRS = registerBlock("frozen_stairs",
            new ModStairsBlock(ModBlocks.FROZEN_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block SLIMED_STAIRS = registerBlock("slimed_stairs",
            new ModStairsBlock(ModBlocks.SLIMED_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block VIGILANT_STAIRS = registerBlock("vigilant_stairs",
            new ModStairsBlock(ModBlocks.VIGILANT_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block ABYSCULK_STAIRS = registerBlock("abysculk_stairs",
            new ModStairsBlock(ModBlocks.ABYSCULK_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block BOG_SHROOM_STAIRS = registerBlock("bog_shroom_stairs",
            new ModStairsBlock(ModBlocks.BOG_SHROOM_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block SAL_SHROOM_STAIRS = registerBlock("sal_shroom_stairs",
            new ModStairsBlock(ModBlocks.SAL_SHROOM_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block SOLID_ROCK = registerBlock("solid_rock",
            new Block(FabricBlockSettings
                    ...
                    .strength(4.0f)
                    .requiresTool()));
    public static final Block OG_PURPUR_BLOCK = registerBlock("og_purpur_block",
            new Block(FabricBlockSettings
    ...
    public static final Block END_STAIRS = registerBlock("end_stairs",
            new ModStairsBlock(ModBlocks.END_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block BLUISHE_STAIRS = registerBlock("bluishe_stairs",
            new ModStairsBlock(ModBlocks.BLUISHE_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.WARPED_STAIRS)
                    .strength(2.0f)));
    ...
    public static final Block AZALEA_STAIRS = registerBlock("azalea_stairs",
            new ModStairsBlock(ModBlocks.AZALEA_PLANKS.getDefaultState(), FabricBlockSettings
    ...
    public static final Block MOSSIER_SPRUCE_PLANKS = registerBlock("mossier_spruce_planks",
            new Block(FabricBlockSettings
                    ...
                    .strength(2.0f, 3.0f)));
    public static final Block BARREN_GRASS_BLOCK = registerBlock("barren_grass_block",
            new Block(FabricBlockSettings
                    .copy(Blocks.END_STONE)
                    .instrument(Instrument.BASEDRUM)
                    .requiresTool()
    ...
    public static final Block CALLERY_STAIRS = registerBlock("callery_stairs",
            new ModStairsBlock(ModBlocks.CALLERY_PLANKS.getDefaultState(), FabricBlockSettings
                    .copy(Blocks.OAK_STAIRS)
                    .strength(2.0f)));
