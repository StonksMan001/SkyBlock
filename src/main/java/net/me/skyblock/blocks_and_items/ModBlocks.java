...
public class ModBlocks {
    ...
    public static final Block VOID_BLOCK = registerBlock("void_block",
            new Block(FabricBlockSettings.copy(Blocks.SCULK).strength(3.0f).emissiveLighting(ModBlocks::always)));
    ...
    public static final Block OG_PURPUR_BLOCK = registerBlock("og_purpur_block",
            new Block(FabricBlockSettings.copy(Blocks.PURPUR_BLOCK).mapColor(MapColor.MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F)));
    public static final Block END_GRASS = registerBlock("end_grass",
            new Block(FabricBlockSettings.copy(Blocks.END_STONE).sounds(BlockSoundGroup.GRASS).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 7.5F)));
    public static final Block BLUISHE_GRASS = registerBlock("bluishe_end_stone",
            new Block(FabricBlockSettings.copy(Blocks.END_STONE).instrument(Instrument.BASEDRUM).requiresTool().strength(3.0F, 9.0F)));
    ...
    public static final Block END_FLOWER = registerBlock("end_flower",
            new EndFlower(FabricBlockSettings.copy(Blocks.DANDELION).sounds(BlockSoundGroup.SPORE_BLOSSOM)));
