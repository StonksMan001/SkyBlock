    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, AncientPedestalBlockEntity blockEntity) {
        if (!world.isClient) {
            for (PlayerEntity playerEntity : world.getPlayers()) {
                ...
                if (!playerEntity.isCreative() && !playerEntity.isSpectator() && playerEntity.getBlockPos().equals(pos.up()) && playerEntity.totalExperience > NuggetOfExperienceItem.EXPERIENCE_POINTS && playerEntity.isSneaking() && world.getBlockState(pos.up()).isAir()) {
