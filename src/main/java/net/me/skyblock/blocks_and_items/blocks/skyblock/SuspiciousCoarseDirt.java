        ...
        if (i) {
            ...
            if (itemStack.isOf(Items.GLASS_BOTTLE)) {
                ...
                if (itemStack.isEmpty()) {
                    player.setStackInHand(hand, new ItemStack(ModItems.SKYBLOCK__ANT_BOTTLE));
                } else if (!player.getInventory().insertStack(new ItemStack(ModItems.SKYBLOCK__ANT_BOTTLE))) {
                    player.dropItem(new ItemStack(ModItems.SKYBLOCK__ANT_BOTTLE), false);
                }
                bl = true;
