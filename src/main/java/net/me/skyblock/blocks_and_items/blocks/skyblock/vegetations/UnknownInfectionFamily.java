package net.me.skyblock.blocks_and_items.blocks.skyblock.vegetations;
...
public class UnknownInfectionFamily extends Block {
    ...
    public Map<Block, Block> infectionTwins() {
        return Map.ofEntries(
                Map.entry(Blocks.GRASS_BLOCK, ModBlocks.SKYBLOCK__UNKNOWN_DIRT_NYLIUM),
                Map.entry(Blocks.DIRT, ModBlocks.SKYBLOCK__UNKNOWN_DIRT)
        );
    }
