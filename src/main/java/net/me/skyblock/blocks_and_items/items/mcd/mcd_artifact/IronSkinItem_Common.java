...
public class IronSkinItem_Common extends Item {
    public IronSkinItem_Common(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient() && hand == Hand.MAIN_HAND ) {
            ...
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 160, 2, false, false, true));
            ...
            if (!list.isEmpty()) {
                ...
                while(var10.hasNext()) {
                    ...
                    if (user.getBlockPos().isWithinDistance(playerEntity.getBlockPos(), (double)j)) {
                        playerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 160, 2, false, false, true));
                    }
                }
