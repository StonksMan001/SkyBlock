package net.me.skyblock.blocks_and_items.items.mcd.mcd_ranged;
...
public class AutoCrossbowItem extends RangedWeaponItem implements Vanishable {
    ...
    public AutoCrossbowItem(Item.Settings settings) {
        super(settings);
    }
