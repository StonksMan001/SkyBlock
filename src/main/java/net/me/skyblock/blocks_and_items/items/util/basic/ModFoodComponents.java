...
public class ModFoodComponents {
    public static final FoodComponent SP5__ENDERITE_APPLE = new FoodComponent.Builder().hunger(4)
            ...
            .alwaysEdible().build();
    public static final FoodComponent SP5__ENCHANTED_ENDERITE_APPLE = new FoodComponent.Builder().hunger(4)
            .saturationModifier(1.2f)
