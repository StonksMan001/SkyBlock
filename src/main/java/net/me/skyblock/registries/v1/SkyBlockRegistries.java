...
import net.me.skyblock.blocks.brainrot.BrainrottenSandBlock;
import net.me.skyblock.blocks.brainrot.BrainrottenSoilBlock;
import net.me.skyblock.blocks.brainrot.BrainrotCore;
import net.me.skyblock.blocks.brainrot.GrimaceShakeBlock;
...
public class SkyBlockRegistries {
    ...
    public static class JukeBoxSongRegistries {
        public static final RegistryKey<JukeboxSong> WITHERSTORM_THEME = SkyBlock.BuiltinRegistries.ofJukeBlockSongRegistry("wither_storm_theme");
    }
    ...
    public static class ItemGroupRegistries {
        public static final ItemGroup SKYBLOCK_FEATURES = SkyBlock.BuiltinRegistries.registerItemGroup( "skyblock_features",
                FabricItemGroup.builder().displayName(Text.literal("SkyBlock-Multimod")).icon(() -> new ItemStack(GhostItemRegistries.Z__LOGO1)).entries((displayContext, entries) -> {
                    ...
                    ItemGroupRegistries.addSpaces(entries, 11,0);
                    entries.add(BlockRegistries.SKYBLOCK__CHERT);
                    entries.add(BlockRegistries.SKYBLOCK__COBBLED_CHERT);
                    entries.add(BlockRegistries.SKYBLOCK__COBBLED_CHERT_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__COBBLED_CHERT_SLAB);
                    entries.add(BlockRegistries.SKYBLOCK__CHISELED_CHERT);
                    entries.add(BlockRegistries.SKYBLOCK__POLISHED_CHERT);
                    entries.add(BlockRegistries.SKYBLOCK__POLISHED_CHERT_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__POLISHED_CHERT_SLAB);
                    entries.add(BlockRegistries.SKYBLOCK__CHERT_BRICKS);
                    entries.add(BlockRegistries.SKYBLOCK__CHERT_BRICK_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__CHERT_BRICK_SLAB);
                    entries.add(BlockRegistries.SKYBLOCK__CHERT_PILLAR);
                    ItemGroupRegistries.addSpaces(entries, 11,6);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_COBBLESTONE);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_COBBLESTONE_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_COBBLESTONE_SLAB);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_STONE_BRICKS);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_STONE_BRICK_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__TANGLY_STONE_BRICK_SLAB);
                    ItemGroupRegistries.addSpaces(entries, 17,3);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE_SLAB);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICKS);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICK_STAIRS);
                    entries.add(BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICK_SLAB);
                    ItemGroupRegistries.addSpaces(entries, 20,3);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 23, 5);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 28, 6);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 34, 7);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 41, 4);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 45, 0);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 45, 5);
                    ...
                    ItemGroupRegistries.addSpaces(entries, 50, 2);
    ...
    public static class BlockRegistries {
        ...
        //ABYSS
        //BRAINROT
        public static final Block BRAINROT__BRAINROT_CORE = SkyBlock.BuiltinRegistries.registerBlockAndItem("brainrot__brainrot_core",
                new BrainrotCore(AbstractBlock.Settings
                        .copy(Blocks.HEAVY_CORE)
                        .mapColor(MapColor.PINK)));
        public static final Block BRAINROT__GRIMACE_SHAKE = SkyBlock.BuiltinRegistries.registerBlockAndItem("brainrot__grimace_shake",
                new GrimaceShakeBlock(AbstractBlock.Settings
                        .copy(Blocks.COBWEB)
                        .sounds(BlockSoundGroup.HONEY)
                        .mapColor(MapColor.MAGENTA)));
        public static final Block BRAINROT__BRAINROTTEN_SOIL = SkyBlock.BuiltinRegistries.registerBlockAndItem("brainrot__brainrotten_soil",
                new BrainrottenSoilBlock(AbstractBlock.Settings
                        .copy(Blocks.ROOTED_DIRT)
                        .mapColor(MapColor.BLACK)));
        public static final Block BRAINROT__BRAINROTTEN_SAND = SkyBlock.BuiltinRegistries.registerBlockAndItem("brainrot__brainrotten_sand",
                new BrainrottenSandBlock(new ColorCode(14406560), AbstractBlock.Settings
                        .copy(Blocks.SAND)
                        .mapColor(MapColor.BLACK)));
        public static final Block BRAINROT__BRAINROTTEN_SPROUTS = SkyBlock.BuiltinRegistries.registerBlockAndItem("brainrot__brainrotten_sprouts",
                new BaseShortPlantBlock(AbstractBlock.Settings
                        .copy(Blocks.NETHER_SPROUTS)
                        .mapColor(MapColor.BLACK), BRAINROT__BRAINROTTEN_SOIL)); //TODO: common tagkey for brainrot ground
        //BRAINROT
        //SKYBLOCK MAIN-BLOCK
        ...
        public static final Block SKYBLOCK__UNKNOWN_DIRT_NYLIUM = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__unknown_dirt_nylium",
                new Block(AbstractBlock.Settings
                        .copy(Blocks.DIRT))); //TODO: MAPCOLOR
        ...
        public static final Block SKYBLOCK__DRIED_TANGLY_COBBLESTONE = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_cobblestone",
                new TanglyStoneBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE)
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.COBBLESTONE));
        public static final Block SKYBLOCK__DRIED_TANGLY_COBBLESTONE_STAIRS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_cobblestone_stairs",
                new TanglyStoneStairsBlock(BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE.getDefaultState(), AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE_STAIRS)
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.COBBLESTONE_STAIRS));
        public static final Block SKYBLOCK__DRIED_TANGLY_COBBLESTONE_SLAB = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_cobblestone_slab",
                new TanglyStoneSlabBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE_SLAB)
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.COBBLESTONE_SLAB));
        public static final Block SKYBLOCK__DRIED_TANGLY_STONE_BRICKS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_stone_bricks",
                new TanglyStoneBlock(AbstractBlock.Settings
                        ...
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.STONE_BRICKS));
        public static final Block SKYBLOCK__DRIED_TANGLY_STONE_BRICK_STAIRS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_stone_brick_stairs",
                new TanglyStoneStairsBlock(BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICKS.getDefaultState(), AbstractBlock.Settings
                        .copy(Blocks.MOSSY_STONE_BRICK_STAIRS)
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.STONE_BRICK_STAIRS));
        public static final Block SKYBLOCK__DRIED_TANGLY_STONE_BRICK_SLAB = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__dried_tangly_stone_brick_slab",
                new TanglyStoneSlabBlock(AbstractBlock.Settings
                        ...
                        .mapColor(MapColor.STONE_GRAY), Items.DRIED_KELP, Blocks.STONE_BRICK_SLAB));
        public static final Block SKYBLOCK__TANGLY_COBBLESTONE = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_cobblestone",
                new TanglyStoneBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.COBBLESTONE, BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE));
        public static final Block SKYBLOCK__TANGLY_COBBLESTONE_STAIRS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_cobblestone_stairs",
                new TanglyStoneStairsBlock(BlockRegistries.SKYBLOCK__TANGLY_COBBLESTONE.getDefaultState(), AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE_STAIRS)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.COBBLESTONE_STAIRS, BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE_STAIRS));
        public static final Block SKYBLOCK__TANGLY_COBBLESTONE_SLAB = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_cobblestone_slab",
                new TanglyStoneSlabBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_COBBLESTONE_SLAB)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.COBBLESTONE_SLAB, BlockRegistries.SKYBLOCK__DRIED_TANGLY_COBBLESTONE_SLAB));
        public static final Block SKYBLOCK__TANGLY_STONE_BRICKS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_stone_bricks",
                new TanglyStoneBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_STONE_BRICKS)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.STONE_BRICKS, BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICKS));
        public static final Block SKYBLOCK__TANGLY_STONE_BRICK_STAIRS = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_stone_brick_stairs",
                new TanglyStoneStairsBlock(BlockRegistries.SKYBLOCK__TANGLY_STONE_BRICKS.getDefaultState(), AbstractBlock.Settings
                        .copy(Blocks.MOSSY_STONE_BRICK_STAIRS)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.STONE_BRICK_STAIRS, BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICK_STAIRS));
        public static final Block SKYBLOCK__TANGLY_STONE_BRICK_SLAB = SkyBlock.BuiltinRegistries.registerBlockAndItem("skyblock__tangly_stone_brick_slab",
                new TanglyStoneSlabBlock(AbstractBlock.Settings
                        .copy(Blocks.MOSSY_STONE_BRICK_SLAB)
                        .mapColor(MapColor.STONE_GRAY), Items.KELP, Blocks.STONE_BRICK_SLAB, BlockRegistries.SKYBLOCK__DRIED_TANGLY_STONE_BRICK_SLAB));
        //SPORE PLANTER BOXES
    ...
    public static class GameRuleRegistries {
        ...
        public static final GameRules.Key<GameRules.IntRule> BRAINROT__BRAINROT_SPREAD_CHANCE = GameRuleRegistry.register("brainrot__brainrotSpreadChance", GameRules.Category.UPDATES, GameRuleFactory.createIntRule(10));
    ...
    public static class ArmorMaterialRegistries {
        ...
        public static final RegistryEntry<ArmorMaterial> ENDERITE = SkyBlock.BuiltinRegistries.registerArmorMaterial("sp5__enderite",
        ...
        public static final RegistryEntry<ArmorMaterial> ABERYTHE = SkyBlock.BuiltinRegistries.registerArmorMaterial("abyss__aberythe",
                Util.make(new EnumMap<ArmorItem.Type, Integer>(ArmorItem.Type.class), map -> {
            map.put(ArmorItem.Type.BOOTS, 5);
