...
public class ModGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanRule> MCD__POP_FLOWERS_ALWAYS_HIDE = GameRuleRegistry.register("mcd__pop_flowers_always_hide", GameRules.Category.UPDATES, GameRuleFactory.createBooleanRule(false));
